...
function Banner() {
  return (
    <>
      <div className='bg-white max-w-screen-2xl container md:mt-12 mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
        ...
        <div className='w-full md:w-1/2 mt-14 md:mt-22 order-1'>
