  ...
  return (
    <>
      <div className='max-w-screen-2xl container md:mt-12 mx-auto md:px-20 px-4 flex flex-col md:flex-row'>
        ...
        <h1 className='text-4xl font-bold'>Welcome, Unlock your potential with <span className='text-4xl mt-8 md:text-6xl text-blue-700 font-bold'>EC<sup>2</sup> !!!</span> </h1>
